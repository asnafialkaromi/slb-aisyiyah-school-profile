    ...
    <div className="navbar fixed bg-white shadow-sm px-4 z-10">
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        <div className="navbar-start">
          ...
          <Link
            to="/"
            className="btn p-0 btn-ghost text-xs hover:bg-transparent hover:shadow-none hover:text-primary hover:border-none focus:border-none not-focus:border-none"
          >
